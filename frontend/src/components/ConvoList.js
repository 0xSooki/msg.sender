...
export default function ConvoList(props){
    ...
    const setBob = (bob) => {
        ...
        for (let i=0; i < myConvos[bob].length; i++){
            if(myConvos[bob][i].from === bob){
                ...
                console.log("just set bobs pub key", myConvos[bob][i].pubkeyX, 
    ...
    return(
        <Box sx={{width:"100%", height:"600px", padding:"2px", borderRadius:"9px",
